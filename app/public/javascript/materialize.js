...
"undefined" == typeof jQuery &&
    ...
    (function(t) {
        ...
        t.extend(t.easing, {
            ...
            easeOutElastic: function(t) {
                return 0 === t ?
                    0 :
                    1 === t ? 1 : i(2, -10 * t) * o((10 * t - 0.75) * c) + 1;
            },
            ...
            if (!t.jQuery) {
                ...
                (i.data = function(t, e, o) {
                    if (void 0 === o) {
                        ...
                        var r =
                            t[i.expando] || (t[i.expando] = ++i.uuid);
                ...
                (i.fn = i.prototype = {
                    ...
                    offset: function() {
                        var e = this[0].getBoundingClientRect ?
                            this[0].getBoundingClientRect() : { top: 0, left: 0 };
                        return {
                            top: e.top +
                                (t.pageYOffset ||
                                    document.scrollTop ||
                    ...
                    position: function() {
                        function t() {
                            for (
                                var t = this.offsetParent || document; t &&
                        ...
                        var e = this[0],
                            t = t.apply(e),
                            n = this.offset(),
                            o = /^(?:body|html)$/i.test(t.nodeName) ? { top: 0, left: 0 } :
                            i(t).offset();
                        return (
                            (n.top -=
                                parseFloat(e.style.marginTop) || 0),
                            (n.left -=
                                parseFloat(e.style.marginLeft) || 0),
                            t.style &&
                            ((o.top +=
                                    parseFloat(
                                    ...
                                    if (r(T)) {
                                            ...
                                            if ("element" !== A) {
                                                ...
                                                if (
                                                    ...
                                                    if (
                                                        ...
                                                        D &&
                                                            (E.rootPropertyValue = D);
                                                    }
                                                    var q = k.setPropertyValue(
                                                        T,
                                                        A,
                                                        E.currentValue +
                                                        (0 ===
                                        ...
                                        c.mobileHA &&
                                            ...
                                            ((r(
                                                    ...
                                                    "(0px, 0px, 0px)"),
                                                (S = !0)),
                                            S && k.flushTransformCache(T);
                                    }
                                }
                                c.display !== n &&
                                    "none" !== c.display &&
                                    (b.State.calls[a][2].display = !1),
                                    c.visibility !== n &&
                                    "hidden" !== c.visibility &&
                                    (b.State.calls[
                                        a
                ...
                function d(t, e) {
                    ...
                    for (
                        ...
                        if (
                            ...
                            p.each(k.Lists.transforms3D, function(t, e) {
                                    ...
                                    r(d).transformCache[e] !== n &&
                                        ...
                                        ((h = !0),
                                            delete r(d).transformCache[e]);
                                }),
                                a.mobileHA &&
                                ((h = !0),
                                    delete r(d).transformCache.translate3d),
                                h && k.flushTransformCache(d),
                                k.Values.removeClass(
                                    d,
                                    "velocity-animating"
                                );
                        }
                        ...
                        s && !0 !== a.loop && s(o),
                            ...
                            !0 === a.loop &&
                            !e &&
                            (p.each(r(d).tweensContainer, function(
                                    t,
                                    e
                                ) {
                                    /^rotate/.test(t) &&
                    ...
                    if (!(7 >= h)) {
                        ...
                        var w = (function() {
                            ...
                            function i(i, n) {
                                var o = { dx: i.v, dv: t(i) },
                                    ...
                                    1 /
                                    6 *
                                    (o.dx + 2 * (a.dx + r.dx) + s.dx),
                                    c =
                                    1 /
                                    6 *
                                    (o.dv + 2 * (a.dv + r.dv) + s.dv);
                                return (
                                    (i.x = i.x + l * n),
                                    (i.v = i.v + c * n),
                                    i
                        ...
                        var k = (b.CSS = {
                            ...
                            Hooks: {
                                ...
                                register: function() {
                                    for (
                                        a = 0; a < k.Lists.colors.length; a++
                                    ) {
                                        var t =
                                            "color" === k.Lists.colors[a] ?
                                            "0 0 0 1" :
                                            "255 255 255 1";
                                        k.Hooks.templates[
                                            k.Lists.colors[a]
                                ...
                                cleanRootPropertyValue: function(t, e) {
                                    return (
                                        ...
                                        k.Values.isCSSNullValue(e) &&
                                        (e = k.Hooks.templates[t][1]),
                                        e
                                    );
                                },
                                extractValue: function(t, e) {
                                    ...
                                    if (i) {
                                        var n = i[0],
                                            o = i[1];
                                        return (e = k.Hooks.cleanRootPropertyValue(
                                                n,
                                                e
                                            ))
                                            .toString()
                                ...
                                injectValue: function(t, e, i) {
                                    ...
                                    if (n) {
                                        var o,
                                            ...
                                            r = n[1];
                                        return (
                                            (i = k.Hooks.cleanRootPropertyValue(
                                                a,
                                                i
                                            )),
                                            (o = i
                                                .toString()
                                                .match(k.RegEx.valueSplit)),
                                            (o[r] = e),
                                            o.join(" ")
                                        );
                                    }
                            ...
                            Normalizations: {
                                    ...
                                    clip: function(t, e, i) {
                                        switch (t) {
                                            ...
                                            case "extract":
                                                var n;
                                                return (
                                                    k.RegEx.wrappedValueAlreadyExtracted.test(
                                                        i
                                                    ) ?
                                                    (n = i) :
                                                    ((n = i
                                ...
                                register: function() {
                                    ...
                                    for (
                                        t = 0; t < k.Lists.transformsBase.length; t++
                                    )
                                        !(function() {
                                            var e =
                                                k.Lists.transformsBase[t];
                                            k.Normalizations.registered[
                                                e
                                            ] = function(t, i, o) {
                                                switch (t) {
                                    ...
                                    for (
                                        var t = 0; t < k.Lists.colors.length; t++
                                    )
                                        !(function() {
                                    ...
                                    for (
                                        ...
                                        if (
                                            ((o =
                                                ...
                                                v.isString(
                                                    b.State.prefixElement.style[
                                                        o
                                                    ]
                                                ))
                                        )
                                            return (
                                                (b.State.prefixMatches[
                                                    t
                                                ] = o), [o, !0]
                                            );
                                    }
                            ...
                            Values: {
                                ...
                                getDisplayType: function(t) {
                                    var e =
                                        t &&
                                        t.tagName.toString().toLowerCase();
                            ...
                            getPropertyValue: function(t, i, o, a) {
                                function s(t, i) {
                                    ...
                                    if (8 >= h) l = p.css(t, i);
                                        ...
                                        (f =
                                            ...
                                            (r(
                                                t
                                            ).computedStyle = e.getComputedStyle(
                                                t,
                                                null
                                            ))),
                                        "borderColor" === i &&
                                ...
                                if (k.Hooks.registered[i]) {
                                    var c = i,
                                        u = k.Hooks.getRoot(c);
                                    o === n &&
                                        (o = k.getPropertyValue(
                                            t,
                                            k.Names.prefixCheck(u)[0]
                                        )),
                                        k.Normalizations.registered[u] &&
                                        (o = k.Normalizations.registered[
                                            u
                                        ]("extract", t, o)),
                                    ...
                                    var d, f;
                                    "transform" !==
                                    (d = k.Normalizations.registered[i](
                                        "name",
                                        t
                                    )) &&
                                    ((f = s(
                                            t,
                                            k.Names.prefixCheck(d)[0]
                                        )),
                                        k.Values.isCSSNullValue(f) &&
                                        k.Hooks.templates[i] &&
                                        (f = k.Hooks.templates[i][1])),
                                    (l = k.Normalizations.registered[i](
                                        "extract",
                                        t,
                                        f
                                    ));
                            ...
                            setPropertyValue: function(t, i, n, o, a) {
                                ...
                                if ("scroll" === i)
                                    ...
                                    if (
                                        (k.Normalizations.registered[i] &&
                                            ((n = k.Normalizations.registered[
                                                    i
                                                ]("inject", t, n)),
                                                (i = k.Normalizations.registered[
                                                    i
                                                ]("name", t))),
                                            (s = k.Names.prefixCheck(i)[0]),
                                            8 >= h)
                                    )
                                        try {
                                            t.style[s] = n;
                            ...
                            flushTransformCache: function(t) {
                                ...
                                if (
                                    ...
                                    var n = {
                                        ...
                                        skewX: [e("skewX")],
                                        skewY: [e("skewY")],
                                        scale: 1 !== e("scale") ? [e("scale"), e("scale")] : [
                                            e("scaleX"),
                                            e("scaleY")
                                        ],
                                        rotate: [e("rotateZ"), 0, 0]
                                    };
                                    p.each(r(t).transformCache, function(
                                        t
                                    ) {
                                        /^translate/i.test(t) ?
                                            (t = "translate") :
                                ...
                                return (
                                    ...
                                    p.each(t, function(t, a) {
                                        if (
                                            ...
                                            o === n &&
                                            (o = b.CSS.getPropertyValue(
                                                a,
                                                e
                                            ));
                                        else {
                                            var s = b.CSS.setPropertyValue(
                                                a,
                                                e,
                                                i
                                            );
                                            "transform" === s[0] &&
                                                b.CSS.flushTransformCache(
                                                    a
                                                ),
                                                (o = s);
                                        }
                        ...
                        var x = function() {
                            ...
                            function o() {
                                function t(t) {
                                    ...
                                    if ("scroll" === A) {
                                        ...
                                        s.container ?
                                            v.isWrapped(s.container) ||
                                            v.isNode(s.container) ?
                                            ((s.container =
                                                    s.container[0] ||
                                                    s.container),
                                                (g =
                                        ...
                                        if (!r(a).tweensContainer)
                                            return void p.dequeue(
                                                a,
                                                s.queue
                                            );
                                        "none" === r(a).opts.display &&
                                                ...
                                                if (
                                                    ...
                                                    if (0 === V) W = F;
                                                        ...
                                                        o =
                                                            ...
                                                            (function() {
                                                                var t = {
                                                                        myParent: a.parentNode ||
                                                                            i.body,
                                                                        position: k.getPropertyValue(
                                                                            a,
                                                                            "position"
                                                                        ),
                                                                        fontSize: k.getPropertyValue(
                                                                            a,
                                                                            "fontSize"
                                                                        )
                                                                    },
                                ...
                                var o,
                                    ...
                                    l = {};
                                switch ((r(a) === n && b.init(a),
                                    parseFloat(s.delay) &&
                                    !1 !== s.queue &&
                                    p.queue(a, s.queue, function(t) {
                                    ...
                                    s.begin &&
                                    !v.isFunction(s.begin) &&
                                    (s.begin = null),
                                    s.progress &&
                                    !v.isFunction(s.progress) &&
                                    (s.progress = null),
                                    s.complete &&
                                    !v.isFunction(s.complete) &&
                                    (s.complete = null),
                                    s.display !== n &&
                                    null !== s.display &&
                                    ((s.display = s.display
                                            ...
                                            .toLowerCase()),
                                        "auto" === s.display &&
                                        (s.display = b.CSS.Values.getDisplayType(
                                            a
                                        ))),
                                    s.visibility !== n &&
                                    null !== s.visibility &&
                                    ...
                                    (s.mobileHA =
                                        s.mobileHA &&
                                        b.State.isMobile &&
                                        !b.State.isGingerbread), !1 === s.queue ?
                                    s.delay ?
                                    setTimeout(t, s.delay) :
                                    t() :
                                    p.queue(a, s.queue, function(
                                        e,
                                        i
                                    ) {
                                        return !0 === i ?
                            ...
                            if (
                                ...
                                var C = f.length,
                                    T = 0;
                                if (!/^(stop|finish)$/i.test(m) &&
                                    !p.isPlainObject(y)
                                ) {
                                    y = {};
                                    for (
                                        var S = h + 1; S < arguments.length; S++
                                    )
                                        ...
                                        (!/^(fast|normal|slow)$/i.test(
                                            ...
                                            !/^\d/.test(arguments[S])) ?
                                        v.isString(arguments[S]) ||
                                        v.isArray(arguments[S]) ?
                                        (y.easing = arguments[S]) :
                                        v.isFunction(
                                            arguments[S]
                                        ) &&
                                        (y.complete =
                                            arguments[S]) :
                                        (y.duration = arguments[S]);
                                }
                                var P = {
                                    promise: null,
                                    resolver: null,
                                ...
                                s &&
                                    b.Promise &&
                                    (P.promise = new b.Promise(function(
                                        t,
                                        e
                                    ) {
    ...
    (function(t, e, i, n) {
        ...
        function k(t, e) {
            for (
                var i, o, a = e[0].toUpperCase() + e.slice(1), r = 0; r < lt.length;
        ...
        function A(t, e) {
            ...
            O(i, e),
                ...
                (e.scale = r ? H(r.pointers, n) : 1),
                (e.rotation = r ? V(r.pointers, n) : 0),
                E(i, e);
            var c = t.element;
        ...
        function N(t, e) {
            ...
            return (
                e & (Tt | St) && (i = w(i.concat(n), "identifier", !0)), [i, n]
            );
        }
        ...
        function F(t, e) {
            ...
            for (o = 0; o < r.length;)
                ...
                e & (Tt | St) && delete n[r[o].identifier],
                o++;
        ...
        function B(t) {
            return t & se ?
                "cancel" :
                t & ae ? "end" : t & oe ? "move" : t & ne ? "start" : "";
        }

        function U(t) {
            return t == _t ?
                "down" :
                t == Et ? "up" : t == At ? "left" : t == Ot ? "right" : "";
        }
        ...
        function ot(t, e) {
            return (
                (e = e || {}),
                (e.recognizers = p(e.recognizers, ot.defaults.preset)),
                new at(t, e)
            );
        }
        ...
        T.prototype = {
            ...
            init: function() {
                this.evEl && h(this.element, this.evEl, this.domHandler),
                    this.evTarget &&
                    h(this.target, this.evTarget, this.domHandler),
                    this.evWin &&
                    h(C(this.element), this.evWin, this.domHandler);
            },
            destroy: function() {
                this.evEl && f(this.element, this.evEl, this.domHandler),
                    ...
                    this.evWin &&
                    f(C(this.element), this.evWin, this.domHandler);
            }
        };
        ...
        c(L, T, {
            handler: function(t) {
                var e = Vt[t.type];
                e & xt && 0 === t.button && (this.pressed = !0),
                    e & Ct && 1 !== t.which && (e = Tt),
                    this.pressed &&
                    this.allow &&
                    (e & Tt && (this.pressed = !1),
        ...
        X.prototype = {
            set: function(t) {
                t == Gt && (t = this.compute()),
                    Ut && (this.manager.element.style[Bt] = t),
        ...
        (Y.prototype = {
            ...
            dropRecognizeWith: function(t) {
                return a(t, "dropRecognizeWith", this) ?
                    this :
            ...
            requireFailure: function(t) {
                ...
                return (
                    (t = G(t, this)), -1 === y(e, t) && (e.push(t), t.requireFailure(this)),
                    this
                );
            },
            ...
            recognize: function(t) {
                ...
                return d(this.options.enable, [this, e]) ?
                    (this.state & (re | se | 32) && (this.state = ie),
                        (this.state = this.process(e)),
                        void(
                            this.state & (ne | oe | ae | se) && this.tryEmit(e)
                        )) :
        ...
        c(Z, Y, {
            ...
            c(J, Z, {
                ...
                attrTest: function(t) {
                    return (
                        ...
                        (this.state & ne ||
                            (!(this.state & ne) && this.directionTest(t)))
                    );
                },
                emit: function(t) {
            ...
            c(tt, Y, {
                ...
                process: function(t) {
                    ...
                    if (
                        ((this._input = t), !n || !i || (t.eventType & (Tt | St) && !a))
                    )
                        this.reset();
            ...
            c(nt, Y, {
                ...
                process: function(t) {
                    var e = this.options,
                        ...
                        n = t.distance < e.threshold,
                        a = t.deltaTime < e.time;
                    if ((this.reset(), t.eventType & xt && 0 === this.count))
    ...
    (function(t) {
        for (
            ...
            (n = t[i[a] + "RequestAnimationFrame"]),
            (o = t[i[a] + "CancelRequestAnimationFrame"]);
        (n && o) ||
        ((n = function(t) {
                var i = +Date.now(),
                    n = Math.max(e + 16, i);
            ...
            this.each(function() {
                ...
                function r(t, i) {
                    i || t.toggleClass("active"),
                        e.accordion || "accordion" === h || void 0 === h ?
                        n(t) :
                        a(t),
                        s(t);
                }
                ...
                if ("destroy" !== o)
                    if (i >= 0 && i < p.length) {
                        ...
                        e.accordion || "accordion" === h || void 0 === h ?
                        r(p.filter(".active").first(), !0) :
                        p.filter(".active").each(function() {
                            r(t(this), !0);
                        });
                else u();
            })
            ...
            void this.each(function() {
                function n() {
                    void 0 !== r.data("induration") &&
                        (s.inDuration = r.data("induration")),
                        void 0 !== r.data("outduration") &&
                        (s.outDuration = r.data(
                            "outduration"
                        )),
                        void 0 !== r.data("constrainwidth") &&
                        (s.constrainWidth = r.data(
                            "constrainwidth"
                        )),
                        void 0 !== r.data("hover") &&
                        (s.hover = r.data("hover")),
                        void 0 !== r.data("gutter") &&
                        (s.gutter = r.data("gutter")),
                        void 0 !== r.data("beloworigin") &&
                        (s.belowOrigin = r.data(
                            "beloworigin"
                        )),
                        void 0 !== r.data("alignment") &&
                        (s.alignment = r.data("alignment")),
                        void 0 !== r.data("stoppropagation") &&
                        (s.stopPropagation = r.data(
                            "stoppropagation"
                        ));
                }
                        ...
                        },
                        {
                            ...
                            value: function() {
                                this.removeEventHandlers(),
                                    ...
                                    this.$overlay[0].parentNode.removeChild(
                                        this.$overlay[0]
                                    ),
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                t.extend(this.$el[0].style, {
                                    ...
                                    e(
                                        this.$overlay[0], { opacity: this.options.opacity }, {
                                ...
                                var n = {
                                    ...
                                    complete: function() {
                                        "function" ==
                                        typeof i.options.ready &&
                                            i.options.ready.call(
                                                i,
                                                i.$el,
                                                i.openingTrigger
                                            );
                                ...
                                this.$el[0].classList.contains(
                                        "bottom-sheet"
                                    ) ?
                                    e(
                                        this.$el[0], { bottom: 0, opacity: 1 },
                                        n
                                    ) :
                                    (e.hook(this.$el[0], "scaleX", 0.7),
                            ...
                            value: function() {
                                ...
                                var i = {
                                    ...
                                    complete: function() {
                                        ...
                                        "function" ==
                                        typeof t.options.complete &&
                                            t.options.complete.call(
                                                t,
                                                t.$el
                                            ),
                                            t.$overlay[0].parentNode.removeChild(
                                                t.$overlay[0]
                                            );
                                    }
                                };
                                this.$el[0].classList.contains(
                                    ...
                                    e(
                                        this.$el[0], { bottom: "-100%", opacity: 0 },
                                        i
                                    ) :
                                    e(
                                        this.$el[0], {
    ...
    (t.fn.modal = function(e) {
        return n.prototype[e] ?
            ...
            void t.error(
                "Method " +
                e +
                " does not exist on jQuery.modal"
            ) :
            (n.init(this, arguments[0]), this);
    });
        ...
        return this.each(function() {
            function e() {
                ...
                s.velocity("stop", !0),
                    ...
                    t("#materialbox-overlay").velocity({ opacity: 0 }, {
                        duration: r,
                        queue: !1,
                        easing: "easeOutQuad",
                        complete: function() {
                ...
                s.wrap(l),
                    s.on("click", function() {
                        ...
                        u / l > d / c ?
                            ...
                            s.velocity({ "max-width": m, width: u }, {
                                duration: 0,
                                queue: !1,
                                complete: function() {
                                    s
                            ...
                            t(document).on("keyup.materialbox", function(
                                t
                            ) {
...
(function(t) {
        ...
        init: function(e) {
            ...
            return this.each(function(i) {
                var o,
                    ...
                    w = function(t) {
                        return Math.floor(
                            t.position().left + u.scrollLeft()
                        );
                    },
                    k = function(t) {
                        m - t >= 0 ?
                            (s.velocity({ right: b(o) }, {
                                    duration: 300,
                                    queue: !1,
                                    easing: "easeOutQuad"
                                }),
                ...
                e.swipeable &&
                    d > e.responsiveThreshold &&
                    (e.swipeable = !1),
                    0 ===
                    (o = t(p.filter('[href="' + location.hash + '"]')))
                    .length &&
                    (o = t(this)
                    ...
                    (m = p.index(o)) < 0 && (m = 0),
                    void 0 !== o[0] &&
                    (a = t(o[0].hash)).addClass("active"),
                    u.find(".indicator").length ||
                    u.append('<li class="indicator"></li>'),
                    (s = u.find(".indicator")),
                    u.append(s),
                    u.is(":visible") &&
                    setTimeout(function() {
                    ...
                    (p.each(function() {
                            var e = t(
                                Materialize.escapeHash(this.hash)
                            );
                            e.addClass("carousel-item"), (f = f.add(e));
                        }),
                        (r = f.wrapAll(
                            '<div class="tabs-content carousel"></div>'
                        )),
                        f.css("display", ""),
                    ...
                    u.off("click.tabs").on("click.tabs", "a", function(i) {
                        if (
                            ...
                            var n = a;
                            (o = t(this)),
                            (a = t(Materialize.escapeHash(this.hash))),
                            (p = u.find("li.tab a"));
                            o.position();
                            o.addClass("active"),
                                (g = m),
                                (m = p.index(t(this))) < 0 && (m = 0),
                                e.swipeable ?
                                f.length &&
                                f.carousel("set", m, function() {
                                    "function" == typeof e.onShow &&
                                        e.onShow.call(u[0], a);
                                }) :
                                (void 0 !== a &&
    ...
    (t.fn.tabs = function(i) {
        return e[i] ?
            ...
            "object" != typeof i && i ?
            void t.error(
                "Method " + i + " does not exist on jQuery.tabs"
            ) :
...
(function(t) {
                        ...
                        "mouseenter.tooltip": function(t) {
                            p = setTimeout(function() {
                                ...
                                "top" === s
                                    ...
                                    (y = Math.SQRT2 * p / parseInt(m)),
                                    (b = Math.SQRT2 * l / parseInt(g)),
                                    (w = Math.max(y, b)),
                                    c
                                    .velocity({
                                        translateY: f,
    ...
    var e = function(e, i, n, o) {
        ...
        return (
            ...
            (a -= a + n - window.innerWidth),
            r < 0 ?
            (r = 4) :
            r + o > window.innerHeight + t(window).scrollTop &&
            (r -= r + o - window.innerHeight), { x: a, y: r }
        );
    };
    t(document).ready(function() {
...
(function(t, e) {
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                this.wasSwiped &&
                                    ...
                                    e(
                                        this.el, { opacity: 0, marginTop: "-40px" }, {
                                            duration: this.options
                                                .outDuration,
                                            easing: "easeOutExpo",
                                            queue: !1,
                        ...
                        },
                        {
                            ...
                            value: function() {
                                document.removeEventListener(
                                    ...
                                    n._container.parentNode.removeChild(
                                        n._container
                                    ),
                                    (n._container = null);
                            }
    ...
    (n._draggedToast = null),
    (Materialize.Toast = n),
    (Materialize.toast = function(t, e, i, o) {
...
(function(t) {
    var e = {
        init: function(e) {
            ...
            t(this).each(function() {
                ...
                e.draggable ?
                    (a.length && a.remove(),
                        (a = t('<div class="drag-target"></div>').attr(
                            "data-sidenav",
                            n
                        )),
                        t("body").append(a)) :
                        ...
                        .on("pan", function(i) {
                            if ("touch" == i.gesture.pointerType) {
                                ...
                                if (
                                    ...
                                    n <
                                        window.innerWidth - e.menuWidth / 2 ?
                                        (l = !0) :
                                        n >=
                                        window.innerWidth -
                                        e.menuWidth / 2 &&
    ...
    t.fn.sideNav = function(i) {
        return e[i] ?
            ...
            "object" != typeof i && i ?
            void t.error(
                "Method " + i + " does not exist on jQuery.sideNav"
            ) :
            e.init.apply(this, arguments);
    };
})(jQuery),
(function(t) {
    ...
    (t.scrollSpy = function(e, n) {
        ...
        (e = t(e)).each(function(e, i) {
                a.push(t(i)),
                    ...
                    t('a[href="#' + t(i).attr("id") + '"]').click(function(e) {
                        e.preventDefault();
                        var i =
                            t(Materialize.escapeHash(this.hash)).offset().top +
                            1;
                        t("html, body").animate({ scrollTop: i - n.scrollOffset }, { duration: 400, queue: !1, easing: "easeOutCubic" });
                    });
            }),
            (c.top = n.offsetTop || 0),
        ...
        return (
            s || (o.on("scroll", d), o.on("resize", d), (s = !0)),
            setTimeout(d, 0),
            e.on("scrollSpy:enter", function() {
                ...
                l[0] ?
                    (t(n.getActiveElement(l[0].attr("id"))).removeClass(
                        ...
                        e.data("scrollSpy:id") < l[0].data("scrollSpy:id") ?
                        l.unshift(t(this)) :
                        l.push(t(this))) :
                    l.push(t(this)),
                    t(n.getActiveElement(l[0].attr("id"))).addClass(
                        n.activeClass
                    );
            }),
            ...
            Materialize.updateTextFields = function() {
                t(
                    ...
                    t(i).val().length > 0 ||
                        ...
                        .siblings("label")
                        .toggleClass(
                            "active", !0 === t(i)[0].validity.badInput
                        ) :
                    ...
                    function() {
                        if (!a) {
                            var e = t(this).children(".thumb"),
                                i =
                                7 +
                                parseInt(t(this).css("padding-left")) +
                                "px";
                            e.hasClass("active") &&
                                e.velocity({
                                    height: "0",
                    ...
                    return (
                        ...
                        this.each(function() {
                            ...
                            if (t.isEmptyObject(o))
                                ...
                                n
                                    .off("blur.autocomplete")
                                    .on("blur.autocomplete", function() {
                                        p();
                                    }),
                                    n
                                    .off(
                                        "keyup.autocomplete focus.autocomplete"
                                    )
                                    .on(
                                        "keyup.autocomplete focus.autocomplete",
                                        function(r) {
                                    ...
                                    .on("keydown.autocomplete", function(
                                        t
                                    ) {
                                        var e,
                                            i = t.which,
                                            ...
                                            .first();
                                        13 === i && r >= 0 ?
                                            (e = c.children("li").eq(r))
                                            .length &&
                                            (e.trigger(
                                                    "mousedown.autocomplete"
                                                ),
                                                t.preventDefault()) :
                                            (38 !== i && 40 !== i) ||
                                            (t.preventDefault(),
                                    ...
                                    .on(
                                        ...
                                        function() {
                                            ...
                                            n.val(i),
                                                ...
                                                p(),
                                                "function" ==
                                                typeof e.onAutocomplete &&
                                                e.onAutocomplete.call(
                                                    this,
                                                    i
                                                );
                                        }
            ...
            t(this).each(function() {
                ...
                if (!n.hasClass("browser-default")) {
                    ...
                    if (
                        (a &&
                            (n
                                ...
                                .remove(),
                                n.unwrap(),
                                t("ul#select-options-" + a).remove()),
                            "destroy" === e)
                    )
                        return (
                            n
                            .removeAttr("data-select-id")
                    ...
                    n.before(m),
                        m.before(f),
                        m.after(l),
                        n.is(":disabled") || m.dropdown({ hover: !1 }),
                        n.attr("tabindex") &&
                        t(m[0]).attr("tabindex", n.attr("tabindex")),
                        n.addClass("initialized"),
                        m.on({
                            focus: function() {
                                if (
                                    (t("ul.select-dropdown")
                                        .not(l[0])
                                        .is(":visible") &&
                                        (t("input.select-dropdown").trigger(
                                                "close"
                                            ),
                                            t(window).off("click.select")), !l.is(":visible"))
                                ) {
...
(function(t) {
                ...
                this.each(function() {
                    function i(t, e) {
                        t.hasClass("center-align") ?
                            t.velocity({ opacity: 0, translateY: -100 }, { duration: e, queue: !1 }) :
                            t.hasClass("right-align") ?
                            t.velocity({ opacity: 0, translateX: 100 }, { duration: e, queue: !1 }) :
                    ...
                    function n(t) {
                        t >= c.length ?
                            ...
                            ((o = c.eq(u)),
                                ...
                                e.indicators && a.eq(t).addClass("active"));
                    }
                    var o,
                        a,
                        r,
                    ...
                    1 != u && (o = c.eq(u)),
                        ...
                        (c
                            ...
                            (u = 0),
                            (o = c.eq(u)),
                            e.indicators && a.eq(u).addClass("active")),
                        ...
                        .on("pan", function(t) {
                            if ("touch" === t.gesture.pointerType) {
                                ...
                                Math.abs(n) > Math.abs(o) &&
                                    $curr_slide.velocity({ translateX: i }, {
                                        duration: 50,
                                        queue: !1,
                                        easing: "easeOutQuad"
                                    }),
                                    4 === e &&
                                    (i > s.innerWidth() / 2 || n < -0.65) ?
                                    (h = !0) :
                                    2 === e &&
                                    (i < -1 * s.innerWidth() / 2 ||
                                        n > 0.65) &&
    ...
    t.fn.slider = function(i) {
        return e[i] ?
            ...
            "object" != typeof i && i ?
            void t.error(
                "Method " + i + " does not exist on jQuery.tooltip"
            ) :
            e.init.apply(this, arguments);
    };
})(jQuery),
...
(function(t) {
    ...
    t(document).ready(function() {
        ...
        (t.fn.material_chip = function(i) {
            ...
            var o = t.extend({}, e, i);
            (n.hasAutocomplete = !t.isEmptyObject(
                o.autocompleteOptions.data
            )),
            (this.init = function() {
                var e = 0;
                n.$el.each(function() {
                    var i = t(this),
                        a = Materialize.guid();
                    (n.chipId = a),
                    (o.data && o.data instanceof Array) ||
                    (o.data = []),
                    i.data("chips", o.data),
                        i.attr("data-index", e),
            ...
            (this.chips = function(e, i) {
                ...
                var r = t("#" + i);
                n.hasAutocomplete &&
                    ((o.autocompleteOptions.onAutocomplete = function(
                            t
                        ) {
            ...
            (this.isValid = function(t, e) {
                for (
                    var i = t.data("chips"), n = !1, o = 0; o < i.length; o++
                )
            ...
            (this.deleteChip = function(t, e) {
                ...
                e
                    ...
                    .remove();
                for (
                    var o = [], a = e.data("chips"), r = 0; r < a.length; r++
                )
                    r !== t && o.push(a[r]);
                e.data("chips", o),
...
(function(t) {
    (Materialize.fadeInImage = function(e) {
        ...
        i.css({ opacity: 0 }),
            t(i).velocity({ opacity: 1 }, { duration: 650, queue: !1, easing: "easeOutSine" }),
    ...
    (Materialize.showStaggeredList = function(e) {
        ...
        i
            ...
            i.find("li").each(function() {
                t(this).velocity({ opacity: "1", translateX: "0" }, { duration: 800, delay: n, easing: [60, 10] }),
                    (n += 120);
            });
    }),
    t(document).ready(function() {
...
(function(t) {
    ...
    Materialize.scrollFire = function(t) {
        var i = function() {
                for (
                    var e = window.pageYOffset + window.innerHeight, i = 0; i < t.length; i++
                ) {
                    var n = t[i],
                        o = n.selector,
                        a = n.offset,
                    ...
                    null !== s &&
                        ...
                        ("function" == typeof r ?
                            r.call(this, s) :
                            "string" == typeof r && new Function(r)(s),
                            (n.done = !0));
                }
            },
...
(function(t) {
    ...
    function e(a, s, u, d) {
        function p() {
            return e._.node(
                ...
                e._.node(
                    ...
                    e._.node(
                        "div",
                        e._.node("div", T.component.nodes(b.open), k.box),
                        k.wrap
                    ),
                    k.frame
                ),
        ...
        function h() {
            x
                ...
                .addClass(k.input)
                .attr("tabindex", -1)
                .val(x.data("value") ? T.get("select", w.format) : a.value),
                w.editable ||
                x
                .on("focus." + b.id + " click." + b.id, function(
                    t
                ) {
                ...
                .on(
                    ...
                    function() {
                        var e = t(this),
                            i = e.data(),
                            n =
                            e.hasClass(k.navDisabled) ||
                            e.hasClass(k.disabled),
                            o = r();
                        (o = o && (o.type || o.href) && o),
                        (n || (o && !t.contains(T.$root[0], o))) &&
                        T.$root.eq(0).focus(), !n && i.nav ?
                            T.set(
                                "highlight",
                                T.component.item.highlight, { nav: i.nav }
                            ) :
                            !n && "pick" in i ?
                            (T.set("select", i.pick),
                                w.closeOnSelect && T.close(!0)) :
                            i.clear ?
                            (T.clear(),
                                w.closeOnSelect && T.close(!0)) :
                            i.close && T.close(!0);
        ...
        function v() {
            ...
            !0 === w.hiddenName ?
                ...
                (e =
                    (e = [
                        "string" == typeof w.hiddenPrefix ?
                        w.hiddenPrefix :
                        "",
                        "string" == typeof w.hiddenSuffix ?
                        w.hiddenSuffix :
                        "_submit"
                    ])[0] +
                    a.name +
                ...
                (T._hidden = t(
                    ...
                    (x.data("value") || a.value ?
                        ' value="' +
                        T.get("select", w.formatSubmit) +
                        '"' :
                        "") +
                    ">"
                )[0]),
                x.on("change." + b.id, function() {
                    T._hidden.value = a.value ?
                        T.get("select", w.formatSubmit) :
                        "";
                }),
                w.container ?
                t(w.container).append(T._hidden) :
                x.before(T._hidden);
        }
        ...
        function m(t) {
            ...
            (32 == e || i || (!b.open && T.component.key[e])) &&
            (t.preventDefault(),
                t.stopPropagation(),
                i ? T.clear().close() : T.open());
        }

        function g(t) {
            t.stopPropagation(),
                "focus" == t.type && T.$root.addClass(k.focused),
                T.open();
        }
        if (!a) return e;
        var y = !1,
            ...
            T = (C.prototype = {
                ...
                start: function() {
                    return b && b.start ?
                        ...
                        ((b.methods = {}),
                            ...
                            (b.type = a.type),
                            (a.autofocus = a == r()),
                            (a.readOnly = !w.editable),
                            (a.id = a.id || b.id),
                            "text" != a.type && (a.type = "text"),
                            (T.component = new u(T, w)),
                            (T.$root = t(
                                e._.node(
                                    "div",
                                    p(),
                            ...
                            (y = i(T.$root.children()[0])),
                            a.autofocus && T.open(),
                            T.trigger("start").trigger("render"));
                },
                render: function(t) {
                    return (
                        t ?
                ...
                stop: function() {
                    return b.start ?
                        (T.close(),
                            T._hidden &&
                            T._hidden.parentNode.removeChild(T._hidden),
                            T.$root.remove(),
                            x.removeClass(k.input).removeData(s),
                            setTimeout(function() {
                                x.off("." + b.id);
                            }, 0),
                            (a.type = b.type),
                ...
                close: function(t) {
                    return (
                        ...
                        x.removeClass(k.active),
                        o(a, "expanded", !1),
                        setTimeout(function() {
                            T.$root.removeClass(k.opened + " " + k.focused),
                                o(T.$root[0], "hidden", !0);
                        }, 0),
                        b.open ?
                        ((b.open = !1),
                ...
                set: function(e, i, n) {
                    ...
                    if (((n = r && t.isPlainObject(i) ? i : n || {}), e)) {
                        ...
                        for (o in s)
                            (a = s[o]),
                            o in T.component.item &&
                            (void 0 === a && (a = null),
                                T.component.set(o, a, n)),
                            ("select" != o && "clear" != o) ||
                            x
                            .val(
                                "clear" == o ?
                ...
                off: function() {
                    var t,
                        ...
                        i = arguments;
                    for (
                        t = 0, namesCount = i.length; t < namesCount; t += 1
                    )
    ...
    return (
        ...
        (e._ = {
            group: function(t) {
                for (
                    var i, n = "", o = e._.trigger(t.min, t); o <= e._.trigger(t.max, t, [o]); o += t.i
                )
            ...
            isDate: function(t) {
                return ({}.toString.call(t).indexOf("Date") > -1 &&
...
(function(t) {
    ...
    (i.prototype.set = function(t, e, i) {
        ...
        return null === e ?
            ...
            ((o[
                        "enable" == t ? "disable" : "flip" == t ? "enable" : t
                    ] = n.queue[t]
                    .split(" ")
                    .map(function(o) {
                        return (e = n[o](t, e, i));
    ...
    (i.prototype.create = function(t, i, o) {
        ...
        return (
            ...
            ((i = new Date(i[0], i[1], i[2])),
                (i = n.isDate(i) ? i : r.create().obj)) :
            (i =
                n.isInteger(i) || n.isDate(i) ?
                r.normalize(new Date(i), o) :
                r.now(t, i, o)), {
    ...
    (i.prototype.createRange = function(t, i) {
        var o = this,
            a = function(t) {
                return !0 === t || e.isArray(t) || n.isDate(t) ?
                    o.create(t) :
                    t;
            };
        return (
            n.isInteger(t) || (t = a(t)),
            n.isInteger(i) || (i = a(i)),
            n.isInteger(t) && e.isPlainObject(i) ?
            (t = [i.year, i.month, i.date + t]) :
            n.isInteger(i) &&
            e.isPlainObject(t) &&
            (i = [t.year, t.month, t.date + i]), { from: a(t), to: a(i) }
        );
    }),
    ...
    (i.prototype.measure = function(t, e) {
        ...
        return (
            ...
            "string" == typeof e ?
            (e = i.parse(t, e)) :
            n.isInteger(e) && (e = i.now(t, e, { rel: e })) :
            (e = "min" == t ? -1 / 0 : 1 / 0),
            e
        );
    }),
    ...
    (i.prototype.disabled = function(t) {
        var i = this,
            o = i.item.disable.filter(function(o) {
                return n.isInteger(o) ?
                    t.day === (i.settings.firstDay ? o : o - 1) % 7 :
                    e.isArray(o) || n.isDate(o) ?
                    t.pick === i.create(o).pick :
                    e.isPlainObject(o) ?
                    i.withinRange(o, t) :
                    void 0;
            });
        return (
            (o =
                ...
                }).length), -1 === i.item.enable ?
            !o :
            o ||
            t.pick < i.item.min.pick ||
            t.pick > i.item.max.pick
        );
    }),
    ...
    (i.prototype.nodes = function(t) {
        var e = this,
            ...
            h = function(t) {
                return n.node(
                    "div",
                    " ",
                    i.klass["nav" + (t ? "Next" : "Prev")] +
                    ((t &&
                            l.year >= d.year &&
                            l.month >= d.month) ||
                        (!t && l.year <= u.year && l.month <= u.month) ?
                        " " + i.klass.navDisabled :
                        ""),
                    "data-nav=" +
                    (t || -1) +
                    ...
                    ' title="' +
                    (t ? i.labelMonthNext : i.labelMonthPrev) +
                    '"'
                );
            },
            f = function(o) {
                var a = i.showMonthsShort ?
                    i.monthsShort :
                    i.monthsFull;
                return (
                    "short_months" == o && (a = i.monthsShort),
                    i.selectMonths && void 0 == o ?
                    n.node(
                        "select",
                        n.group({
                            min: 0,
                    ...
                    "short_months" == o ?
                    null != r ? a[r.month] : a[l.month] :
                    n.node("div", a[l.month], i.klass.month)
                );
            },
            v = function(o) {
                var a = l.year,
        ...
        return (
            ...
            (createWeekdayLabel = function() {
                var t;
                return (
                    (t = null != r ? r.day : a.day), i.weekdaysShort[t]
                );
            }),
            n.node(
                "div",
                n.node("div", v("raw"), i.klass.year_display) +
                n.node(
                    "span",
                    createWeekdayLabel() + ", ",
...
(function(t) {
    ...
    function o(o, r) {
                ...
                E.setHand(l, c, !e, !0),
                    s.off(h).on(h, function(t) {
                        ...
                        var e = /^touch/.test(t.type),
                            i =
                            (e ? t.originalEvent.touches[0] : t).pageX -
                            o,
                            n =
                            (e ? t.originalEvent.touches[0] : t).pageY -
                            a;
                        (p || i !== l || n !== c) &&
                        ((p = !0), E.setHand(i, n, !1, !0));
                    }),
                    s.off(f).on(f, function(t) {
                        s.off(f), t.preventDefault();
                        var i = /^touch/.test(t.type),
                            n =
                            (i ? t.originalEvent.changedTouches[0] : t)
                            .pageX - o,
                            u =
                            (i ? t.originalEvent.changedTouches[0] : t)
                            .pageY - a;
                        (e || p) && n === l && u === c && E.setHand(n, u),
                            "hours" === E.currentView ?
                            E.toggleView("minutes", x / 2) :
                            r.autoclose &&
                            (E.minutesView.addClass(
        ...
        r.twelvehour &&
            (r.ampmclickable ?
                (this.spanAmPm.empty(),
                    ...
                    .appendTo(this.spanAmPm)) :
                (this.spanAmPm.empty(),
                    t('<div id="click-am">AM</div>').appendTo(
                        this.spanAmPm
                    ),
                    t('<div id="click-pm">PM</div>').appendTo(
                        this.spanAmPm
                    ))),
            t(
            ...
            this.spanMinutes.click(
                t.proxy(this.toggleView, this, "minutes")
            ),
            A.on(
                "focus.clockpicker click.clockpicker",
                t.proxy(this.show, this)
            );
        var _,
            M,
            I,
        ...
        if (
            (d.on(p, function(e) {
                    0 === t(e.target).closest(".clockpicker-tick").length &&
                        l(e, !0);
                }),
                c)
        ) {
            var z = u.find(".clockpicker-canvas"),
                V = e("svg");
            V.setAttribute("class", "clockpicker-svg"),
                V.setAttribute("width", k),
                V.setAttribute("height", k);
            var H = e("g");
            H.setAttribute("transform", "translate(" + g + "," + g + ")");
            var L = e("circle");
            L.setAttribute("class", "clockpicker-canvas-bearing"),
                L.setAttribute("cx", 0),
                L.setAttribute("cy", 0),
                L.setAttribute("r", 4);
            var j = e("line");
        ...
        if (!this.isShown) {
            ...
            if (
                ((this.hours = +o[0] || 0),
                    ...
                    this.spanMinutes.html(i(this.minutes)), !this.isAppended)
            ) {
            ...
            this.toggleView("hours"),
                ...
                s.on(
                    ...
                    function(e) {
                        var i = t(e.target);
                        0 ===
                            i.closest(n.popover.find(".picker__wrap"))
                            .length &&
                            0 === i.closest(n.input).length &&
                            n.hide();
                    }
                ),
    ...
    (o.prototype.hide = function() {
        a(this.options.beforeHide),
            ...
            this.popover.hide(),
            a(this.options.afterHide);
    }),
    (o.prototype.toggleView = function(e, i) {
        var n = !1;
        "minutes" === e &&
            "visible" === t(this.hoursView).css("visibility") &&
            (a(this.options.beforeHourSelect), (n = !0));
        var o = "hours" === e,
        ...
        this.spanHours.toggleClass("text-primary", o),
            ...
            n && a(this.options.afterHourSelect);
    }),
    (o.prototype.resetClock = function(t) {
        ...
        c && t ?
            (l.canvas.addClass("clockpicker-canvas-out"),
                setTimeout(function() {
                    l.canvas.removeClass("clockpicker-canvas-out"),
                        l.setHand(r, s);
                }, t)) :
            this.setHand(r, s);
    }),
    (o.prototype.setHand = function(e, n, o, a) {
        ...
        if (
            (p.twelvehour && (f = y),
                ...
                (this[this.currentView] = r),
                l ? this.spanHours.html(r) : this.spanMinutes.html(i(r)),
                c)
        ) {
            ...
            this.hand.setAttribute("x2", m),
                ...
                this.bg.setAttribute("cx", k),
                this.bg.setAttribute("cy", x);
        } else
    ...
    (o.prototype.remove = function() {
        this.element.removeData("clockpicker"),
            ...
            this.isAppended &&
            (r.off("resize.clockpicker" + this.id),
                this.popover.remove());
    }),
    (t.fn.pickatime = function(e) {
        ...
        return this.each(function() {
            ...
            if (a) "function" == typeof a[e] && a[e].apply(a, i);
            else {
                var r = t.extend({},
                    o.DEFAULTS,
                    n.data(),
...
(function(t) {
            ...
            return this.each(function(i) {
                ...
                function s(i) {
                    ...
                    var n,
                        ...
                        d = w;
                    if (
                        ((b = "number" == typeof i ? i : b),
                            (w = Math.floor((b + x / 2) / x)),
                            (a = b - w * x),
                            (s = a < 0 ? 1 : -1),
                            (l = -s * a * 2 / x),
                            (o = C >> 1),
                ...
                function c() {
                    ...
                    P &&
                        ((t = Date.now() - I),
                            (i = P * Math.exp(-t / e.duration)) > 2 || i < -2 ?
                            (s(A - i), requestAnimationFrame(c)) :
                            s(A));
                }
                ...
                function d(t) {
                    ...
                    W ||
                        (e < 0 ?
                            Math.abs(e + C) < Math.abs(e) && (e += C) :
                            e > 0 && Math.abs(e - C) < e && (e -= C)),
                        e < 0 ?
                        j.trigger("carouselNext", [Math.abs(e)]) :
                        e > 0 && j.trigger("carouselPrev", [e]);
                }
                ...
                function f(t) {
                    if (k)
                        return (
                            ...
                            q && (t.preventDefault(), t.stopPropagation()), !1
                        );
                }
                var v,
                    m,
                ...
                var Q = function(e) {
                    var i = j.find(".carousel-item.active").length ?
                        j.find(".carousel-item.active").first() :
                        j.find(".carousel-item").first(),
                        n = i.find("img").first();
                    if (n.length)
                        if (n[0].complete)
                ...
                j.addClass("initialized"),
                    ...
                    (g = j
                        ...
                        .innerHeight()),
                    (x = 2 * m + e.padding),
                    j.find(".carousel-item").each(function(e) {
                    ...
                    N && j.append(V),
                    (C = v.length),
                    (_ = "transform"), ["webkit", "Moz", "O", "ms"].every(function(t) {
                        var e = t + "Transform";
                        return (
                ...
                t(window)
                    .off("resize.carousel-" + F)
                    .on("resize.carousel-" + F, X),
                    void 0 !== window.ontouchstart &&
                    (j.on("touchstart.carousel", p),
                        j.on("touchmove.carousel", h),
                        j.on("touchend.carousel", f)),
                    j.on("mousedown.carousel", p),
                    j.on("mousemove.carousel", h),
                    j.on("mouseup.carousel", f),
                    j.on("mouseleave.carousel", f),
                    j.on("click.carousel", u),
                    s(b),
                    t(this).on("carouselNext", function(t, e, i) {
                        void 0 === e && (e = 1),
                            "function" == typeof i && (L = i),
                            (A = x * Math.round(b / x) + x * e),
                            b !== A &&
                            ((P = A - b),
                                (I = Date.now()),
                                requestAnimationFrame(c));
    ...
    t.fn.carousel = function(i) {
        return e[i] ?
            ...
            "object" != typeof i && i ?
            void t.error(
                "Method " + i + " does not exist on jQuery.carousel"
            ) :
            e.init.apply(this, arguments);
    };
})(jQuery),
    ...
    var e = {
        init: function(e) {
            return this.each(function() {
                ...
                o.length ||
                    (o = n
                        .wrap(t('<div class="tap-target-wrapper"></div>'))
                        .parent()),
                    s.length ||
                    ((s = t('<div class="tap-target-content"></div>')),
                        n.append(s)),
                    a.length ||
                    ((a = t('<div class="tap-target-wave"></div>')),
                        r.length ||
                        ((r = i.clone(!0, !0)).addClass(
                                "tap-target-origin"
                            ),
                            r.removeAttr("id"),
                            r.removeAttr("style"),
                ...
                var l = function() {
                    ...
                    c = function() {
                        ...
                        if (!e)
                            for (
                                var r = i.parents(), l = 0; l < r.length &&
                                !(e = "fixed" == t(r[l]).css("position")); l++
                            );
                        var c = i.outerWidth(),
                            u = i.outerHeight(),
                            d = e ?
                        ...
                        o.css(H),
                            ...
                            a.css({ top: z, left: V, width: D, height: q });
                    };
                "open" == e &&
                    (c(),
                        o.is(".open") ||
